...
var (
	...
	backgroundQuestions = map[string][]string{
		"aurifex":        {"What experiment went horribly wrong?", "What alchemical marvel is the product of your latest ingenuity?"},
		"barber-surgeon": {"How have you “improved” yourself?", "What rare tool is essential to your work?"},
		"beast handler":  {"What creature is your specialty?", "What do creatures of the wild understand that your kind do not?"},
		...
		"half witch":     {"What did you bring back from the unseelie court?", "What concoction do you carry, and what rare ingredients did you gather to make it?"},
